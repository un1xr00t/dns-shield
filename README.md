...
| Alert | Trigger | Discord Color |
|-------|---------|---------------|
| SSH Login | Any SSH login | Blue |
| IP Banned | fail2ban ban | Red |
| DNS Pointing | Unknown host request | Yellow |
| Daily Summary | Cron (9 AM UTC) | Green |
...
| `fail2ban-alert.sh` | `/usr/local/bin/` | Ban notifications |
...
```bash
/usr/local/bin/daily-summary.sh       # Run daily summary
